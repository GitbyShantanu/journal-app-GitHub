package com.shantanu.journalApp.config;

import com.shantanu.journalApp.filter.JwtFilter;
import com.shantanu.journalApp.service.UserDetailsServiceImpl;
...
public class SpringSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement()
                ...
                .and()
                .csrf().disable();
        // Add jwtFilter before UsernamePasswordAuthenticationFilter to ensure
        // JWT validation happens before Spring Security's default authentication logic.
